package com.liqi.talker.factory.data;

import android.support.annotation.NonNull;

import com.liqi.factory.data.DbDataSource;
import com.liqi.talker.factory.data.helper.DbHelper;
import com.liqi.talker.factory.model.db.BaseDbModel;
import com.liqi.utils.CollectionUtil;
...
public abstract class BaseDbRepository<Data extends BaseDbModel<Data>> implements DbDataSource<Data>,
    ...
    // 数据库统一通知的地方: 增加 / 更改
    @Override
    public void onDateSave(Data[] list) {
    ...
    // 数据库统一通知的地方: 删除
    @Override
    public void onDateDelete(Data[] list) {
        // 在删除情况下不用进行过滤判断
        // 当数据库数据删除的操作
        boolean isChanged = false;
        for (Data data : list) {
